...
const TestChatWidget: React.FC = () => {
  ...
  if (!isStarted) {
    return (
      <div className="flex flex-col h-full bg-slate-50 items-center justify-center p-8 border rounded-xl">
  ...
  return (
    <div className="flex flex-col h-[600px] bg-slate-50 border rounded-xl overflow-hidden">

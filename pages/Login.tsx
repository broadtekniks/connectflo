...
const Login: React.FC<LoginProps> = ({ onLogin, onNavigate }) => {
  const [email, setEmail] = useState('sarah@connectflo.com');
    ...
    <div className="min-h-screen bg-white flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 text-white flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
            <h2 className="text-4xl font-bold mb-6 leading-tight">"ConnectFlo cut our response times by 60% in the first week."</h2>
            <div className="flex items-center gap-4">
                <img src="https://picsum.photos/id/338/100/100" alt="Testimonial" className="w-12 h-12 rounded-full border-2 border-indigo-500" />
                <div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-slate-50">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
            ...
            <div className="my-6 flex items-center">
                ...
                <span className="px-4 text-xs text-slate-400 font-medium uppercase">Or continue with</span>
                <div className="flex-1 border-t border-slate-200"></div>
            </div>
            ...
            <p className="text-center mt-8 text-sm text-slate-500">
                Don't have an account? <button onClick={() => onNavigate('signup')} className="text-indigo-600 font-bold hover:underline">Sign up for free</button>
            </p>
        </div>
      </div>
    </div>
